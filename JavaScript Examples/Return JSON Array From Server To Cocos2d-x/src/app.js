...
var HelloWorldLayer = cc.Layer.extend({
    ctor:function () {
        ...
        xhr.open( "GET", "http://www.sonarlearning.co.uk/extras/cocostutorial/jsonarray.php" );
        ...
        xhr.onreadystatechange = function ()
        {
            ...
            if ( xhr.readyState == 4 && ( xhr.status >= 200 && xhr.status <= 207 ) )
            {
                ...
                cc.log( "HTTP Response : key a : " + jsonData["a"] );
                cc.log( "HTTP Response : key b : " + jsonData["b"] );
                cc.log( "HTTP Response : key c : " + jsonData["c"] );
            }
        }
